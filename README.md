...
Significa **govern del poble**, un sistema de govern on les decisions no les pren una sola persona sinó tota la  ciutadania a traves del seus representants. 
...
- **Control del poder**. Els governs estan obligats a rendir comptes. 

--- 

## DIVISIÓ DE PODERS 

Per a evitar que una  persona o acumule tot el poder i n’abuse, el poder es divideix en tres poders independents entre si.
- **Legislatiu**. Aprova les lleis i controla el govern. A Espanya les corts generals representen el poble espanyol. 
- **Judicial**. Responsable de que les lleis es compleixen. A Espanya l'exerceixen els jutjats i els tribunals. 
- **Executiu**. Encarregat de prendre les decisions polítiques i econòmiques. A Espanya l'exerceix el govern. 
...
- Data del 6 de desembre en 1978. 
...
- Formada per diversos municipis. 
- Hi ha 50 províncies. 
...
- En el pla social, perquè tenim la ciutadania vde la UE. Alço ens permet viatjar, estudiar i treballar en qualsevol dels estats membres. A més, 19 països de la UE compartim una moneda única l’euro.
